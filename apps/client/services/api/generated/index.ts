...
export interface FixedLogin {
  /** Username must be 'admin' or 'team1' through 'team24' */
  username: string;
  password: string;
}

export interface FixedLoginResponse {
  message: string;
  userId: string;
  teamId: string;
}
...
> extends HttpClient<SecurityDataType> {
  auth = {
   ...
   fixedAuth = {
     /**
      * Login with fixed team credentials (team1-team24, admin)
      *
      * @tags FixedAuth
      * @name PostFixedAuthLogin
      * @request POST:/fixed-auth/login
      */
     postFixedAuthLogin: (data: FixedLogin, params: RequestParams = {}) =>
       this.request<FixedLoginResponse, any>({
         path: `/fixed-auth/login`,
         method: "POST",
         body: data,
         type: ContentType.Json,
         ...params,
      ...
      *
      * @tags FixedAuth
      * @name PostFixedAuthLogout
      * @request POST:/fixed-auth/logout
      */
     postFixedAuthLogout: (params: RequestParams = {}) =>
       this.request<void, any>({
         path: `/fixed-auth/logout`,
         method: "POST",
         ...params,
       }),
   };
  ...
  adminUsers = {
    ...
    getAdminUsers: (
      ...
      this.request<AdminUsersResponse, any>({
        path: `/admin/users`,
        method: "GET",
        query: query,
        format: "json",
     ...
     *
     * @tags Admin Users
     * @name GetAdminUsersById
     * @request GET:/admin/users/:id
     */
    getAdminUsersById: (id: string, params: RequestParams = {}) =>
      this.request<UsersMeResponse, any>({
        path: `/admin/users/${id}`,
        method: "GET",
        format: "json",
     ...
     */
    postAdminUsers: (data: AdminUserCreate, params: RequestParams = {}) =>
      this.request<{ message: string; userId: string } & UsersMeResponse, any>({
        path: `/admin/users`,
        method: "POST",
        body: data,
        type: ContentType.Json,
    ...
    putAdminUsersById: (
      ...
      this.request<{ message: string } & UsersMeResponse, any>({
        path: `/admin/users/${id}`,
        method: "PUT",
        body: data,
        type: ContentType.Json,
     ...
     *
     * @tags Admin Users
     * @name DeleteAdminUsersById
     * @request DELETE:/admin/users/:id
     */
    deleteAdminUsersById: (id: string, params: RequestParams = {}) =>
     ...
     *
     * @tags Admin Users
     * @name PostAdminUsersByIdResetPassword
